...
import Carouse_226 from '../resources/Carouse_226';
...
import { FlexBox } from '../resources/FlexBox';
import ManufacturerTopInfo_226 from '../resources/ManufacturerTopInfo_226';

const Screen_226 = ({ navigation, companyData }) => {

  //const { companyData } = route.params 
  const [mainCategoryData, setMainCategoryData] = useState(PRODUCTS);
  const [topTrending, setTopTrending] = useState(PRODUCTS.slice(0, 3));
