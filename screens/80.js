...
const Screen_80 = ({ showFeature, setShowFeature, activeFeature, setActiveFeature }) => {
            ...
            <View style={styles.modalBackground}>
                ...
                <View style={styles.modalContent}>
                    ...
                    <View style={{ padding: 10, }}>
                        <Text style={styles.modalTitle}>Feature</Text>
                    </View>
                    <Divider width={1} />
                    <ScrollView showsVerticalScrollIndicator={false}>
                        <View style={{ padding: 10 }}>
                            <FlatList
                                scrollEnabled={false}
                                data={customizeMenuList.feature.options}
                                renderItem={({ item }) => (
                                    <CustomizeElementItem
                                        item={item}
                                        label={customizeMenuList.feature.label}
                                        activeData={activeFeature}
                                        setActiveData={setActiveFeature}
                                    />
                                )}
                            />
                        </View>
